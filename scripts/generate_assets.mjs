...
fs.writeFileSync('C:\\Users\\mkryo\\news_subtitles.srt', srt, 'utf8');
...
<svg xmlns="http://www.w3.org/2000/svg" width="1920" height="1080" viewBox="0 0 1920 1080">
  ...
  fs.writeFileSync(`C:\\Users\\mkryo\\${bg.file}`, svg, 'utf8');
  console.log(`✓ ${bg.file}`);
}

console.log('\n全ファイル生成完了:');
console.log('  C:\\Users\\mkryo\\news_subtitles.srt');
console.log('  C:\\Users\\mkryo\\bg_opening.svg   (オープニング/クロージング)');
console.log('  C:\\Users\\mkryo\\bg_system.svg    (星系レポート)');
console.log('  C:\\Users\\mkryo\\bg_faction.svg   (勢力インテル)');
console.log('  C:\\Users\\mkryo\\bg_market.svg    (マーケット)');
